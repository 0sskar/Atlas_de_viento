...
sed  -i "s/}/ /g" valores_u_v.js
sed  -i "s/}/ /g" coordenadas_lat_lon.js
sed  -i "s/;/];/g" valores_u_v.js
sed  -i "s/UGRD_P0_L6_GLL0 =/U=[/g" valores_u_v.js
sed  -i "s/VGRD_P0_L6_GLL0 =/V=[/g" valores_u_v.js
sed  -i "s/;/];/g" coordenadas_lat_lon.js
sed  -i "s/lat_0 =/lat = [/g" coordenadas_lat_lon.js
sed  -i "s/lon_0 =/lon = [/g" coordenadas_lat_lon.js
